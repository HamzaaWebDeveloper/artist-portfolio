            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card customShadow">
                        <form action="{{route("edit.project.store",['id'=>$project->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-2">
                                        ...
                                        <input type="text" required name="name" class="form-control" placeholder="Enter Project Name" value="{{ $project->name }}">
                                    </div>


                                        <div class="col-lg-12 mb-3">
                                            <label for="" class="fw-bold">Existing Project Images</label>
                                            <div class="d-flex flex-wrap gap-2">
                                                @foreach ($project->projectImages as $image)
                                                    <div style="position: relative; display: inline-block;">
                                                        <img src="{{ asset('project/projectImages/'.$image->project_images) }}" alt="Project Image" class="img-thumbnail" style="width: 150px; height: 100px; object-fit: cover;">
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                        ...
                                        <select name="niche_id" id="" class="form-select" required>
                                            ...
                                            @if ($niche && $niche->isNotEmpty())
                                                @foreach ($niche as $niches)
                                                    <option value="{{ $niches->id }}"
                                                        {{ $project->niche->id == $niches->id ? 'selected' : '' }}>
                                                        {{ $niches->name }}
                                                    </option>
                                                @endforeach
                                            @else
                                    ...
                                    <div class="col-lg-12 mb-2 form-group">
                                        ...
                                        <textarea name="description" class="form-control fw-bold" style="height: 140px !important;" placeholder="Description about the project...">{{ $project->description }}</textarea>
                                    </div>
