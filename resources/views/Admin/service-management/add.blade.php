                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <label for="" class="fw-bold">Thumbnail Image</label>
                                        <input type="file" name="thumbnail_image" id="" class="form-control ">
                                    </div>

                                    <div class="col-lg-6 mb-2">
                                        <label for="" class="fw-bold">Icon Image</label>
                                    ...
                                    <div class="col-lg-12 mb-2 form-group">
                                        ...
                                        <textarea name="service_description" class="form-control fw-bold" style="height: 140px !important;"></textarea>
                                    </div>
